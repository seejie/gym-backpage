...
<div class="cut-ct">
    <div>
        ...
        <div class="imgct">
            <div class="imgct1" :class="{show: active===cut.ratio}" v-for="(cut, index) in cropper" :key="'img'+index">
        ...
        <div class="btns">
            <a href="javascript:;" class="btn" :class="{active: active === cut.ratio}" @click="active=cut.ratio" v-for="(cut,index) in cropper" :key="'btn'+index">
                <div class="btn-text">{{cut.name}}</div>
                <div class="btn-text">{{cut.ratio}}:1</div>
            </a>
    ...
    <div>
        ...
        <div class="ct clearfix" v-for="(cut,index) in cropper" :key="'preview'+index" :style="{height: (133/+cut.ratio)+'px'}">
            <div class="img-preview " :ref="'preview'+cut.ratio" :style="{height: (133/+cut.ratio)+'px'}"></div>
            <div class="describe">
                <div class="name">{{cut.name}}（{{cut.ratio_x ? cut.ratio_x + '：' + cut.ratio_y : cut.ratio + '：1'}}）</div>
