      ...
      <el-col :span="18" :offset="3">
        <el-card shadow="never">
          ...
          <div class="notice-box">
            <div class="notice-item" v-if="announceData.length!=0" v-for="i in 10">
              <span class="item-time">2019-08-25</span>
              <span class="item-txt">
                【系统】这里是标题
              </span>
            </div>
  ...
  export default {
    ...
    methods: {
      ...
      announceList() {
        ...
        this.$ajax.get('/setting/announceList',{params})
          .then(res => {
            if (res.resCode == 200) {
      ...
      //获取公告分类
      categoryList(){
        this.$ajax.get('/setting/categoryList?type=1')
          .then(res => {
            if (res.resCode == 200) {
