      ...
      <div class="styleCustomization">
        <el-form ref="form" :model="styleData"  :rules="rules" label-width="150px">
          ...
          <el-form-item label="版权信息">
            <el-input v-model="styleData.copyright" placeholder="请输入系统名，1-30字"></el-input>
          </el-form-item>
          <el-form-item label="备案信息">
            <el-input v-model="styleData.beianInfo" placeholder="请输入备案号，1-30字"></el-input>
            <br />
            <el-input v-model="styleData.beianUrl" placeholder="请输入域名，点击备案号跳转"></el-input>
          </el-form-item>
          <el-form-item label="">
...
export default {
 ...
 watch: {
  ...
  methods: {
    ...
    styleSave() {
      this.$ajax
        .post('/sys/sys_setting/bindDefaultStyleSetting', {
          ...this.styleData,
        })
        .then(res => {
    ...
    /** 查询默认风格设置信息 */
    queryDefaultStyleSetting() {
      this.$ajax
        .get('/sys/sys_setting/queryDefaultStyleSetting')
        .then(res => {
