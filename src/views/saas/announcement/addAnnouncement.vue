      ...
      <div style="padding-right:20px;">
        <el-form :rules="rules" ref="addData" :model="addData" label-width="100px">
          ...
          <el-form-item label="类型" prop="LabelTyle">
            ...
            <br />
            <el-button style="margin-top: 20px;" @click="outerVisible = true">
              类型管理
            </el-button>
            <el-dialog title="标签管理" :visible.sync="outerVisible" width="40%">
              ...
              >
                ...
                <div slot="footer" class="dialog-footer">
                  <el-button type="primary" @click="submit__category">
                    确 定
                  </el-button>
          ...
          <el-form-item label="发布时间" prop="publish_status">
            <el-radio-group v-model="addData.publish_status">
              ...
              <br />
              <el-radio style="line-height:2.8;" :label="0">
                草稿， 暂不发布
              </el-radio>
              <br />
              <el-radio style="line-height:2.8;" :label="2">定时发布</el-radio>
              <br />
            </el-radio-group>
            <br />
            <el-date-picker
          ...
          <el-form-item>
            ...
            <router-link :to="{ name: 'saas/announcement' }">
