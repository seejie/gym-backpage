...
export default {
  ...
  methods: {
    ...
    loadLoginInfo() {
      this.loginInfo = {"copyright":"版权所有 XXX信息科技有限公司 备案号","beianUrl":"http://www.beian.miit.gov.cn/","shareTitle":"小清柠社群营销服务平台","shareIcon":"http://upload.njlime.com/favicon.ico","sysLogo":"","indexLogo":"","sysName":"test","resCode":200,"说明":"本单位没有配置数据或者参数没有带url，调用admin的配置数据","beianInfo":"苏ICP备17024429号"}
    },
