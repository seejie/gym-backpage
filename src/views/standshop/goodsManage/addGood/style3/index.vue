        ...
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
          ...
          <el-form-item label="商品详情页banner" prop="banner">
            ...
            <div class="uploader-text">
              请上传5M以内图片，支持PNG\JPG等常见格式,最多9张，首张为封面,建议尺寸 550*408
            </div>
          </el-form-item>
          ...
          <el-form-item label="商品类型" prop="productCategoryIdExtras">
            <el-cascader v-model="ruleForm.productCategoryIdExtras" :options="productCategoryIdOptios"></el-cascader>
          </el-form-item>
          <el-form-item label="商品规格" class="upload-container" prop="detailJsonExtra">
            ...
            <div class="upload-icon-logo-text">图片规格1:1<br />建议尺寸<br />55*55</div>
            <PriceTable
